...
// data come in the form of JASON

/* M1

 This shows normal way to pass the props i.e properties resName = "abdul kalam" cuisines = "biryani"

M3) const ResCard = (props) => {
    const {resName, cuisines} = props;
    

M2) const ResCard = ({resName, cuisines}) => { // this is destructuring of data

M1) const ResCard = (props) => {
    return(
    <div className="res-card">
        <img className="res-logo" src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/bz9zkh2aqywjhpankb07"/>

M1) <h2>{props.resName}</h2>
